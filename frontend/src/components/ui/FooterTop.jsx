...
const FooterTop = () => {
  const incentives = [
    {
      name: "Free shipping",
      icon: <TbTruckDelivery className="mx-auto h-16 w-16" />,
      description:
        "It's not actually free we just price it into the products. Someone's paying for it, and it's not us.",
    },
    {
      name: "10-year warranty",
      icon: <IoShieldCheckmarkSharp className="mx-auto h-16 w-16" />,
      description:
        "If it breaks in the first 10 years we'll replace it. After that you're on your own though.",
    },
    {
      name: "Exchanges",
      icon: <MdOutlinePublishedWithChanges className="mx-auto h-16 w-16" />,
      description:
